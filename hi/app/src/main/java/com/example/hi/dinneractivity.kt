...
import com.example.hi.adapter.dinnerAdapter
...
import com.example.hi.utils.Constants3
...
class dinneractivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_dinneractivity)
        ...
        // RecyclerView for dinner items
        val recyclerView = findViewById<RecyclerView>(R.id.recyclerViewdinner)
        recyclerView.layoutManager = LinearLayoutManager(this)
        recyclerView.adapter = dinnerAdapter(Constants3.getProducts())
        ...
        lifecycleScope.launch {
            try {
                ...
                if (latest != null) {
                    ...
                    AlertDialog.Builder(this@dinneractivity)
                        .setTitle("Payment Update")
                        .setMessage(msg)
                        .setPositiveButton("View Order") { _, _ ->
                            val intent = Intent(this@dinneractivity, OrderTrackingDetailActivity::class.java)
